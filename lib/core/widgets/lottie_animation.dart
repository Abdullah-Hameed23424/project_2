...
import 'package:feature_based_with_mvvm/core/constants/app_animations.dart';
...
class LottieAnimation extends StatelessWidget {
  ...
  const LottieAnimation({
    ...
    this.labelColor = AppColors.primaryBase,
    ...
    this.btnSize,
    this.btnColor = AppColors.primarySaturationHigh,
    this.width = 250,
    this.btnLabelColor,
  });
